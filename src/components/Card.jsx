...
const Card = forwardRef((props, ref) => {
  return (
    <div ref={ref} className="overflow-x-hidden">
      <div className="max-w-full w-[12.60431rem] h-[17.33094rem] bg-[#1a3f60] rounded-[0.75388rem] overflow-hidden mx-auto p-4">
        <div className="w-[10.83656rem] h-[10.93075rem] text-white font-pSans text-[0.81669rem] font-light leading-[1.03719rem] tracking-[0.00819rem]">
          {props.content}
        </div>
        <div className="w-[10.83656rem] h-[2.54425rem]">
