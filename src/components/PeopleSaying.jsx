  ...
  return (
    <div className="mt-[10.84rem] flex flex-col">
      <div className="flex justify-center w-[15.81875rem] h-[1.19069rem] mx-auto">
        <div className="text-[#313338] text-center font-pSans text-[1.02056rem] font-semibold leading-[1.20425rem] tracking-[0.01019rem]">
      ...
      <div className="mt-[2.08rem]">
        <div className="flex flex-row justify-between w-auto mx-auto ml-2">
          ...
          <img
            src={image25}
            alt="thamesLogo"
            className="w-[7.4245rem] h-[2.00113rem] mt-3"
          />
          <img
            src={image27}
            alt="tunvay"
            className="w-[4.66319rem] h-[3.75838rem] -mt-3"
          />
        </div>
      </div>
    </div>
