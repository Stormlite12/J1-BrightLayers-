...
const InfiniteCarousel = () => {
  ...
  return (
    <div
      className="flex max-w-[90%] md:max-w-[90%] mac:max-w-[85%] mx-auto justify-start mt-[4rem] md:mt-[6rem] lg:mt-[9rem] mb-[10rem] overflow-x-auto scroll-smooth no-scrollbar"
      ref={containerRef}
    >
