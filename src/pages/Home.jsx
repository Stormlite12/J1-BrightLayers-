...
function Home() {
  ...
  <img src={LetsTalkFloater} className="w-[1rem] h-[1.5rem] " alt="" />
      ...
      <div className="font-title text-center md:text-left mt-[0.91rem] text-[#545454]
             w-[80%] h-[11.83988rem] text-[0.7rem] font-medium leading-[130.238%] tracking-[0.00813rem]
  ...
  >
    check services
      ...
      <div className="w-full flex flex-col justify-center items-center md:mt-[9.48rem] mac:mt-[11.85rem] xl:mt-[13.33rem] mt-[5.06rem]">
        ...
        <div
          className="font-title text-center md:text-left mt-[0.91rem] w-[80%] h-[11.84rem] text-[0.7rem] font-medium leading-[130%] tracking-[0.007rem] 
          sm:w-[25rem] sm:text-[0.9rem] sm:leading-[1.2rem] sm:tracking-[0.009rem]
